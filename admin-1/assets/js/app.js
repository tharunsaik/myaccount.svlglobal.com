! function () {
		...
		function a(a, i) {
				...
				}), i.otherwise(function (a) {
						var i = a.get("$state");
						i.go("app.dashboard")
				})
		}
		var i = angular.module("singApp.core", ["singApp.core.utils", "ui.router", "ui.bootstrap", "ngAnimate", "ngStorage"]);
		i.config(a), a.$inject = ["$stateProvider", "$urlRouterProvider"]
}(),
function () {
		"use strict";

		function a(a, i) {
				return a.fn.widgster.Constructor.DEFAULTS.bodySelector = ".widget-body", a(i).on("close.widgster", function (i) {
						var t = a(i.target).closest('.content > .row > [class*="col-"]:not(.widget-container)');
						t.find(".widget").not(i.target).length || t.remove()
				}), {
						restrict: "CEA",
						link: function (a, i, t) {
								"true" !== t.postProcessing && i.widgster()
						}
				}
		}
...
function () {
		...
		function a(a) {
				return {
						restrict: "C",
						link: function (i, t) {
								a(t).find(".input-group-addon + .form-control").on("blur focus", function (i) {
										a(this).parents(".input-group")["focus" === i.type ? "addClass" : "removeClass"]("focus")
								})
						}
				}
		}
		...
		function t(a, i) {
				return {
						restrict: "A",
						link: function (t, s, o) {
								s.on("click change", function (i) {
										var t = a(this),
												s = a(t.data("ajax-target"));
										return s.length > 0 && (i = a.Event("ajax-load:start", {
												originalEvent: i
										}), t.trigger(i), !i.isDefaultPrevented() && s.load(t.data("ajax-load"), function () {
												t.trigger("ajax-load:end")
										})), !1
								}), o.loadingText && (s.on("ajax-load:start", function () {
										s.button("loading")
								}), s.on("ajax-load:end", function () {
										s.button("reset")
								})), a(i.document).on("click", "[data-toggle^=button]", function (i) {
										return "change" !== a(i.target).find("input").data("ajax-trigger")
								})
						}
				}
		}
		...
		function s(a, i, t) {
				return {
						link: function () {
								a(t).on("ajax-load:end", "#load-notifications-btn", function () {
										i(function () {
												a("#notifications-list").find(".bg-attention").removeClass("bg-attention")
										}, 1e4)
								}), a(t).on("ajax-load:end", "#notifications-toggle input", function () {
										a("#notifications-list").find("[data-toggle=tooltip]").tooltip()
								}), i(function () {
										var t = a("#chat-notification");
										t.removeClass("hide").addClass("animated fadeIn").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
												t.removeClass("animated fadeIn"), i(function () {
														t.addClass("animated fadeOut").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
																t.addClass("hide")
														})
												}, 4e3)
										}), t.siblings('[data-sn-action="toggle-chat-sidebar-state"]').append('<i class="chat-notification-sing animated bounceIn"></i>')
								}, 4e3)
						}
				}
		}
		...
		function o(a) {
				return {
						link: function (i, t) {
								...
								o.css("opacity", 0), a(function () {
										o.css({
												transition: "none",
												width: 0,
												opacity: 1
										}), a(function () {
												o.css("transition", "").css("width", s + "%")
										})
								})
						}
				}
		...
		function l(a) {
				return {
						...
						link: function (i, t) {
								t.on("click", function () {
										t.closest("table").find("input[type=checkbox]").not(this).prop("checked", a(this).prop("checked"))
								})
						}
				}
		}
		...
		function n() {
				return {
						restrict: "E",
						link: function (a, i) {
								i.on("click", "a[href=#]", function (a) {
										a.preventDefault()
								})
						}
				}
		}
		angular.module("singApp.core.utils", []).directive("inputGroupNoBorder", a).directive("inputGroupTransparent", a).directive("ajaxLoad", t).directive("snDemo", s).directive("snProgressAnimate", o).directive("animateNumber", e).directive("checkAll", l).directive("body", n), a.$inject = ["jQuery"], i.$inject = ["jQuery"], t.$inject = ["jQuery", "$window"], s.$inject = ["jQuery", "$timeout", "$document"], o.$inject = ["$timeout"], e.$inject = ["jQuery"], l.$inject = ["jQuery"], n.$inject = []
}(),
function () {
		"use strict";
		...
		function a(a) {
				return {
						link: function (i, t) {
								function s() {
										a(".sidebar-status .dropdown-toggle").after(t.detach())
								}

								function o() {
										a("#notifications-dropdown-toggle").after(t.detach())
								}
								i.app.helpers.onScreenSize("xs", s), i.app.helpers.onScreenSize("xs", o, !1), i.app.helpers.isScreen("xs") && s(), a(".sidebar-status").on("show.bs.dropdown", function () {
...
function () {
		...
		function a(a, i, t) {
				var s = {
						"toggle-navigation-state": function (a, i) {
								i.app.state["nav-static"] = !i.app.state["nav-static"]
						},
						"toggle-navigation-collapse-state": function () {
								a.toggleNavigationCollapseState()
						},
						"toggle-chat-sidebar-state": function () {
								i(this).find(".chat-notification-sing").remove(), a.toggleChatSidebarState(), t(function () {
										i(".chat-sidebar-user-group:first-of-type .list-group-item:first-child:not(.js-notification-added)").addClass("active js-notification-added").find(".fa-circle").after('<span class="badge badge-danger pull-right animated bounceInDown">3</span>')
								}, 1e3)
						}
				};
				return {
						restrict: "A",
						link: function (a, i, t) {
								angular.isDefined(t.snAction) && "" !== t.snAction && i.on("click", function (o) {
										a.$apply(function () {
												s[t.snAction].call(i[0], o, a)
										}), o.preventDefault()
								}), angular.isDefined(t.tooltip) && "" !== t.snAction && i.tooltip()
						}
				}
		}

		function i(a, i, t, s, o) {
				var e = function (a, t) {
						this.$el = a, this.scope = t, this.helpers = t.app.helpers, i.toggleNavigationCollapseState = s.proxy(this.toggleNavigationCollapseState, this)
				};
				return e.prototype = {
						expandNavigation: function () {
								this.isNavigationStatic() && (this.helpers.isScreen("md") || this.helpers.isScreen("lg")) || (s("body").removeClass("nav-collapsed"), this.$el.find(".active .active").closest(".collapse").collapse("show").siblings("[data-toggle=collapse]").removeClass("collapsed"))
						},
						collapseNavigation: function () {
								this.isNavigationStatic() && (this.helpers.isScreen("md") || this.helpers.isScreen("lg")) || (s("body").addClass("nav-collapsed"), this.$el.find(".collapse.in").collapse("hide").siblings("[data-toggle=collapse]").addClass("collapsed"))
						},
						...
						changeActiveNavigationItem: function (a, i, s) {
								var o = this.$el.find('a[href="' + t.href(i, s) + '"]');
								o.is(".active > .collapse > li > a") || this.$el.find(".active .active").closest(".collapse").collapse("hide"), this.$el.find(".sidebar-nav .active").removeClass("active"), o.closest("li").addClass("active").parents("li").addClass("active"), o.closest(".collapse").addClass("in").siblings("a[data-toggle=collapse]").removeClass("collapsed")
						},
						toggleNavigationCollapseState: function () {
								s("body").is(".nav-collapsed") ? this.expandNavigation() : this.collapseNavigation()
						},
						enableSwipeCollapsing: function () {
								var a = this;
								s(".content-wrap").swipe({
										swipeLeft: function () {
												a.helpers.isScreen("lg") || s("body").is(".nav-collapsed") || a.collapseNavigation()
										},
										swipeRight: function () {
												a.helpers.isScreen("lg") || s("body").is(".nav-busy") || s("body").is(".nav-collapsed") && a.expandNavigation()
										},
						...
						link: function (l, n) {
								...
								var d = new e(n, l);
								n.on("mouseenter", s.proxy(d._sidebarMouseEnter, d)), n.on("mouseleave", s.proxy(d._sidebarMouseLeave, d)), a(function () {
										d.changeActiveNavigationItem({}, t.$current, t.params), d.checkNavigationState()
								}), n.on("click", function () {
										s("body").is(".nav-collapsed") && d.expandNavigation()
								}), l.$watch('app.state["nav-static"]', function (i, t) {
										i !== t && (i || d.collapseNavigation(), a(function () {
												s(o).trigger("sn:resize")
										}))
								}), i.$on("$stateChangeStart", s.proxy(d.changeActiveNavigationItem, d)), i.$on("$stateChangeSuccess", s.proxy(d.collapseNavIfSmallScreen, d)), i.$on("$stateChangeSuccess", function () {
										o.scrollTo(0, 0)
								}), "ontouchstart" in o && d.enableSwipeCollapsing(), n.find(".collapse").on("show.bs.collapse", function (a) {
										if (a.target === a.currentTarget) {
												var i = s(this).prev("[data-toggle=collapse]");
												s(i.data("parent")).find(".collapse.in").not(s(this)).collapse("hide")
										}
								}).on("show.bs.collapse", function (a) {
										a.target === a.currentTarget && s(this).closest("li").addClass("open")
								}).on("hide.bs.collapse", function (a) {
										a.target === a.currentTarget && s(this).closest("li").removeClass("open")
								}), s(o).on("sn:resize", c), c()
						}
				}
		}
		angular.module("singApp.core").directive("snAction", a).directive("snNavigation", i), a.$inject = ["$rootScope", "jQuery", "$timeout"], i.$inject = ["$timeout", "$rootScope", "$state", "jQuery", "$window"]
}(),
function () {
		"use strict";
		...
		function a(a, i, t, s) {
				return {
						...
						link: function (o, e) {
								function l() {
										var a = i(".chat-sidebar-contacts", e);
										0 !== e.find(".slimScrollDiv").length && a.slimscroll({
												destroy: !0
										}), a.slimscroll({
								...
								var n = i("body").addClass("chat-sidebar-container");
								a.toggleChatSidebarState = function () {
										n.toggleClass("chat-sidebar-opened")
								}, i(s).on("swipeLeft", ".content-wrap", function () {
										n.is(".nav-collapsed") && n.addClass("chat-sidebar-opened")
								}).on("swipeRight", function () {
										n.is(".nav-collapsed.chat-sidebar-opened") && n.removeClass("chat-sidebar-opened").addClass("nav-busy").one(i.support.transition.end, function () {
												i("body").removeClass("nav-busy")
										}).emulateTransitionEnd(300)
								}), o.deactivateLink = function (a) {
										i(a.currentTarget).removeClass("active").find(".badge").remove()
								}, i(t).on("sn:resize", l), l()
						}
				}
		}
		...
		function i(a) {
				a.todayConversations = [{
						...
						lastMessage: "Just ain't sure about the weekend now. 90% I'll make it.",
						image: "assets/images/avatar.png"
				}], a.newMessage = "", a.activeConversation = a.todayConversations[0], a.chatAreaOpened = !1, a.openConversation = function (i) {
						a.activeConversation = i, a.chatAreaOpened = !0
				}, a.addMessage = function (i) {
				...
				return {
						...
						link: function (a, i, t) {
								a.$watch("open", function (a) {
										i.toggleClass("open", a), i.closest(".chat-sidebar-content").find(".chat-sidebar-contacts").toggleClass("open", !a), i.closest(".chat-sidebar-content").find(".chat-sidebar-footer").toggleClass("open", a), a && i.find(".message-list").slimscroll({
												height: i.height() - i.find(".title").height() - 10 - parseInt(i.css("margin-top")) - parseInt(i.css("margin-bottom")),
												width: "",
												size: "4px"
										})
								})
		...
		angular.module("singApp.core").directive("snChatSidebar", a).directive("snChatArea", t).controller("ChatSidebarController", i), a.$inject = ["$rootScope", "jQuery", "$window", "$document"], i.$inject = ["$scope"], t.$inject = []
}(),
function () {
		"use strict";
								...
								function o() {
										t.bootstrapWizard({
												onTabShow: function (a, i, s) {
														var o = i.find("li").length,
																e = s + 1,
																l = e / o * 100,
																n = t;
														n.find(".progress-bar").css({
																width: l + "%"
														}), e >= o ? (n.find(".pager .next").hide(), n.find(".pager .finish").show(), n.find(".pager .finish").removeClass("disabled")) : (n.find(".pager .next").show(), n.find(".pager .finish").hide()), i.find("li").removeClass("done"), a.prevAll().addClass("done")
												},
												onNext: function (i, t, s) {
														var o = a(i.find("a[data-toggle=tab]").attr("href")),
																e = o.find("form");
														return e.length ? e.parsley().validate() : void 0
												},
												onTabClick: function (a, i, t, s) {
														return i.find("li:eq(" + s + ")").is(".done")
												}
										}), s.height && t.find(".tab-pane").css({
												height: s.height
										})
								}
								o()
...
function () {
		...
		function a() {
				return {
						restrict: "EAC",
						link: function (a, i, t) {
								i.css("height", t.height).liveTile(), a.$on("$stateChangeStart", function () {
										i.liveTile("destroy", !0)
								})
						}
				}
		}
...
function () {
		...
		function a(a, i, t, s) {
				function o(t, o, e, l) {
						...
						i(function () {
								var i = new a.Switchery(o[0], n),
										s = i.element;
								s.checked = t.initValue, i.setPosition(!1), s.addEventListener("change", function (a) {
										t.$apply(function () {
												l.$setViewValue(s.checked)
										})
								})
						}, 0)
				}
...
function () {
		...
		function a(a) {
				return {
						require: "ngModel",
						link: function (i, t, s, o) {
								function e() {
										var e = angular.isString(o.$viewValue) ? o.$viewValue.replace(/(^,)|(,$)/g, "") : o.$viewValue,
												l = i[s.options];
										if (angular.isArray(e) && angular.isArray(l)) l.forEach(function (i, s) {
												0 === s ? t.sparkline(e[s], i) : t.sparkline(e[s], a.extend({
														composite: !0
												}, i))
										});
										else {
												var n;
												n = angular.isArray(e) ? e : e.split(","), t.sparkline(n, l)
										}
								}
								i.$watch(s.ngModel, function () {
										e()
								})
						}
				}
...
function () {
		...
		function a(a) {
				return {
						link: function (i, t, s) {
								var o = new a({
										color: i.$eval(s.color)
								});
								o.set(t[0], s.skyCon), o.play()
						}
				}
		}
		...
		angular.module("singApp.components.skycon").directive("skyCon", a).factory("Skycons", i), a.$inject = ["Skycons"], i.$inject = ["$window"]
}(),
function () {
		"use strict";
...
function () {
						...
						link: function (o, e, l) {
								function n() {
										function n() {
												...
												c.configure(a), c.render(), e.find("svg").css({
														height: o.height
												})
										}
										var c = new t.Graph({
										...
										s(a).on("sn:resize", n), n();
										new t.Graph.HoverDetail({
												graph: c,
												xFormatter: function (a) {
														return new Date(1e3 * a).toString()
												}
										});
										o.realtime && i(function () {
												o.random.removeData(o.seriesData), o.random.addData(o.seriesData), c.update()
										}, 1e3)
								}
								o.$watch("series", function (a, i) {
		...
		angular.module("singApp.components.rickshaw").directive("rickshawChart", a).factory("Rickshaw", i), a.$inject = ["$window", "$interval", "Rickshaw", "jQuery"], i.$inject = ["$window"]
}(),
function () {
		"use strict";
...
function () {
				...
				return {
						link: function (o, e, l) {
								function n() {
										t.addGraph(function () {
												var t = o[l.chart];
												return s.select(e.find("svg")[0]).style("height", l.height || "300px").datum(o[l.datum]).transition().duration(500).call(t), i(a).on("sn:resize", t.update), t
										})
								}
								n()
						}
		...
		angular.module("singApp.components.nvd3").directive("nvd3Chart", a).factory("nv", i).factory("d3", t), a.$inject = ["$window", "jQuery", "nv", "d3"], i.$inject = ["$window"], t.$inject = ["$window"]
}(),
function () {
		"use strict";
...
function () {
		...
		function a() {
				return {
						require: "ngModel",
						link: function (a, i, t, s) {
								function o() {
										a.$watch(t.ngModel, function (s, o) {
												if (angular.isDefined(s)) {
														var e = i;
														e.css("height", t.height || 394).css("margin-bottom", t.marginBottom || -15), e.parents(".widget")[0] && e.find(".map").css("height", parseInt(e.parents(".widget").css("height")) - 40), e.mapael(s), a[t.zoom] && e.trigger("zoom", a[t.zoom]), a.$map = e
												}
										})
								}
								o()
				...
				return {
						link: function (t, s, o) {
								function e() {
										s.css({
												height: o.height
										}), a.Morris[i(o.type)](angular.extend({
												element: s[0]
										}, t[o.options]))
								}
								e()
...
function () {
		...
		function a(a, i, t, s) {
				if (!angular.isDefined(s.GMaps)) {
						var o = s.document.createElement("script");
						o.type = "text/javascript", o.src = "http://maps.google.com/maps/api/js?sensor=true&callback=googleMapsLoaded", s.document.body.appendChild(o), a.gmapsLoaded = !1, window.googleMapsLoaded = function () {
								var i = s.document.createElement("script");
								i.type = "text/javascript", i.src = "vendor/gmaps/gmaps.js", i.onload = function () {
										a.$apply(function () {
												a.gmapsLoaded = !0
										})
								}, s.document.body.appendChild(i)
						}
				}
				return {
						link: function (o, e, l) {
								function n() {
												...
												options: [{
														...
														action: function (a) {
																this.addMarker({
																		lat: a.latLng.lat(),
																		lng: a.latLng.lng(),
																		animation: s.google.maps.Animation.DROP,
																		draggable: !0,
																		title: "New Marker"
										...
										})), t("[data-gmap-zoom-in]").on("click", function () {
												a.zoomIn(1)
										}), t("[data-gmap-zoom-out]").on("click", function () {
												a.zoomOut(1)
										}), i(function () {
												a.addMarker({
														lat: -37.813179,
...
function () {
		...
		function a(a, i, t) {
				return {
						link: function (s, o, e) {
								var l = o.find(".js-shuffle-sizer");
								a(function () {
										o.shuffle(angular.extend({
												sizer: l
										}, s.$eval(e.options))), a(function () {
												o.shuffle("shuffle", "all")
										})
								}), t(i).on("sn:resize", function () {
										o.shuffle("update")
								}), s.$grid = o
						}
				}
...
function () {
		...
		function a(a) {
				return function (i, t, s) {
						var o, e;
						o = angular.extend({}, i[s.dropzone]), e = new a(t[0], o.options), angular.forEach(o.eventHandlers, function (a, i) {
								e.on(i, a)
						})
				}
		}
		...
		angular.module("singApp.components.dropzone").directive("dropzone", a).factory("Dropzone", i), a.$inject = ["Dropzone"], i.$inject = ["$window"]
}(),
function () {
		"use strict";
...
function () {
		...
		function a(a) {
				return {
						link: function (i, t, s) {
								a.plot(t, i[s.ngModel], i[s.options] || {
										series: {
												lines: {
														show: !0,
														lineWidth: 1,
...
function () {
		...
		var i = angular.module("singApp.widgets", ["ui.router", "ui.bootstrap", "singApp.components.mapael", "singApp.components.tile", "singApp.components.flot", "singApp.components.skycon", "singApp.components.sparkline", "ui.jq"]);
		i.config(a), a.$inject = ["$stateProvider"]
}(),
function () {
		"use strict";
		...
		function a(a, i, t) {
				a.applyToScope = function () {
						a.selectedYear = 2009, a.$watch("selectedYear", function (t, s) {
								t !== s && a.$map.trigger("update", [i[t], {}, {}, {
										animDuration: 300
								}])
						}), a.data = {
								map: {
								...
								areas: i[a.selectedYear].areas
						};
						var s = t.fn.mapael.maps.world_countries.getCoords(59.599254, 8.863224);
						a.zoom = [6, s.x, s.y]
				}, a.applyToScope()
		}
		...
		function i(a) {
				a.generateRandomData = function (a) {
						...
						for (var t = [], s = 5, o = 0; o < a.length; o++) {
								for (var e = [], l = 0; 25 > l; l++) e.push([l, Math.floor(s * l) + i()]);
								s--, t.push({
										data: e,
										showLabels: !0,
										label: a[o].label,
		...
		function t(a, i) {
				a.applyToScope = function () {
						a.data = [4, 6, 5, 7, 5], a.options = {
								...
								tooltipFormat: new i.SPFormatClass('<span style="color: white">&#9679;</span> {{prefix}}{{y}}{{suffix}}'),
		...
		function s(a, i) {
				a.applyToScope = function () {
						a.seriesData = [
								[],
								[]
						], a.random = new i.Fixtures.RandomData(30);
						for (var t = 0; 30 > t; t++) a.random.addData(a.seriesData);
						a.series = [{
		...
		function o(a, i, t) {
				a.applyRickshawData = function () {
						for (var i = [
										[],
										[]
								], s = new t.Fixtures.RandomData(1e4), o = 0; 32 > o; o++) s.addData(i);
						a.series = [{
								name: "pop",
								data: i.shift().map(function (a) {
										return {
												x: a.x,
												y: a.y
										}
						...
						var t = [3, 6, 2, 4, 5, 8, 6, 8],
								s = a.app.helpers.max(t),
								o = t.map(function () {
										return s
								});
						a.sparklineData = [o, t], a.sparklineOptions = [{
								type: "bar",
								height: 26,
								barColor: a.app.settings.colors["gray-lighter"],
								barWidth: 7,
								barSpacing: 5,
								chartRangeMin: a.app.helpers.min(t),
								tooltipFormat: new i.SPFormatClass("")
						}, {
								composite: !0,
								type: "bar",
		...
		angular.module("singApp.widgets").controller("YearsMapDemoController", a).controller("FlotChartDemoController", i).controller("NasdaqSparklineDemoController", t).controller("RealtimeTrafficWidgetDemoController", s).controller("ChangesChartWidgetDemoController", o), a.$inject = ["$scope", "fakeWorldData", "jQuery"], i.$inject = ["$scope"], t.$inject = ["$scope", "jQuery"], s.$inject = ["$scope", "Rickshaw"], o.$inject = ["$scope", "jQuery", "Rickshaw"]
}(),
function () {
		"use strict";
...
function () {
		...
		var i = angular.module("singApp.ui.tabs-accordion", ["ui.router"]);
		i.config(a), a.$inject = ["$stateProvider"]
}(),
function () {
		"use strict";
		...
		var i = angular.module("singApp.ui.notifications", ["ui.router"]);
		i.config(a), a.$inject = ["$stateProvider"]
}(),
function () {
		"use strict";
		...
		function a(a, i, t) {
				function s() {
						(function () {
								var t, s, o, e = {}.hasOwnProperty,
										l = function (a, i) {
												function t() {
														this.constructor = a
												}
												for (var s in i) e.call(i, s) && (a[s] = i[s]);
												return t.prototype = i.prototype, a.prototype = new t, a.__super__ = i.prototype, a
										};
								t = i, o = '<div class="messenger-spinner">\n    <span class="messenger-spinner-side messenger-spinner-side-left">\n        <span class="messenger-spinner-fill"></span>\n    </span>\n    <span class="messenger-spinner-side messenger-spinner-side-right">\n        <span class="messenger-spinner-fill"></span>\n    </span>\n</div>', s = function (a) {
										function t() {
												return t.__super__.constructor.apply(this, arguments)
										}
										return l(t, a), t.prototype.template = function (a) {
												var s;
												return s = t.__super__.template.apply(this, arguments), s.append(i(o)), s
										}, t
						...
						link: function (a, o) {
								function e() {
										...
										i.globalMessenger({
												...
												theme: a
										}, t().post("Thanks for checking out Messenger!");
										var o = ["bottom", "right"],
												e = i(".location-selector"),
												l = function () {
														for (var s = "messenger-fixed", e = 0; e < o.length; e++) s += " messenger-on-" + o[e];
														i.globalMessenger({
																extraClasses: s,
																theme: a
														}), t.options = {
										...
										l(), e.locationSelector().on("update", function (a) {
												o = a, l()
										}), i("#show-error-message").on("click", function () {
												var a;
												return a = 0, t().run({
										...
										}), i("#show-info-message").on("click", function () {
												var a = t().post({
												...
												return !1
										}), i("#show-success-message").on("click", function () {
												return t().post({
		...
		angular.module("singApp.ui.notifications").directive("messengerDemo", a).factory("Messenger", i), a.$inject = ["$window", "jQuery", "Messenger"], i.$inject = ["$window"]
}(),
function () {
		"use strict";
		...
		var i = angular.module("singApp.ui.list-groups", ["ui.router", "ui.jq"]);
		i.config(a), a.$inject = ["$stateProvider"]
}(),
function () {
		"use strict";
		...
		var i = angular.module("singApp.ui.icons", ["ui.router"]);
		i.config(a), a.$inject = ["$stateProvider"]
}(),
function () {
		"use strict";
		...
		var i = angular.module("singApp.ui.components", ["ui.router", "ui.bootstrap"]);
		i.config(a), a.$inject = ["$stateProvider"]
}(),
function () {
		"use strict";
		...
		function a(a, i) {
				a.alerts = [{
						type: "success",
						msg: i.trustAsHtml('<span class="fw-semi-bold">Success:</span> You successfully read this important alert message.')
				}, {
						type: "info",
						msg: i.trustAsHtml('<span class="fw-semi-bold">Info:</span> This alert needs your attention, but it\'s not super important.')
				}, {
						type: "warning",
						msg: i.trustAsHtml('<span class="fw-semi-bold">Warning:</span> Best check yo self, you\'re not looking too good.')
				}, {
						type: "danger",
						msg: i.trustAsHtml('<span class="fw-semi-bold">Danger:</span> Change this and that and try again.  <a class="btn btn-default btn-xs pull-right mr" href="#">Ignore</a>  <a class="btn btn-danger btn-xs pull-right mr-xs" href="#">Take this action</a>')
				}], a.addAlert = function () {
						a.alerts.push({
								type: "warning",
								msg: i.trustAsHtml("Another alert!")
						})
				}, a.closeAlert = function (i) {
						a.alerts.splice(i, 1)
				}
		}
		...
		angular.module("singApp.ui.components").controller("UiComponentsDemoController", a).controller("ModalDemoCtrl", i).controller("ModalInstanceCtrl", t), a.$inject = ["$scope", "$sce"], i.$inject = ["$scope", "$modal", "$log"], t.$inject = ["$scope", "$modalInstance"]
}(),
function () {
		"use strict";
		...
		var i = angular.module("singApp.ui.buttons", ["ui.router"]);
		i.config(a), a.$inject = ["$stateProvider"]
}(),
function () {
		"use strict";
		...
		var i = angular.module("singApp.tables.dynamic", ["ui.router", "ngResource", "datatables", "datatables.bootstrap"]);
		i.config(a), a.$inject = ["$stateProvider"]
}(),
function () {
		"use strict";
		...
		function a(a, i, t, s) {
				s.extend(s.fn.dataTableExt.oPagination, {
						bootstrap: {
								fnInit: function (a, i, t) {
										var o = a.oLanguage.oPaginate,
												e = function (i) {
														i.preventDefault(), a.oApi._fnPageChange(a, i.data.action) && t(a)
												};
										s(i).append('<ul class="pagination no-margin"><li class="prev disabled"><a href="#">' + o.sPrevious + '</a></li><li class="next disabled"><a href="#">' + o.sNext + "</a></li></ul>");
										var l = s("a", i);
										s(l[0]).bind("click.DT", {
												action: "previous"
										}, e), s(l[1]).bind("click.DT", {
												action: "next"
										}, e)
								},
								fnUpdate: function (a, i) {
										function t(t) {
												t.preventDefault(), a._iDisplayStart = (parseInt(s("a", this).text(), 10) - 1) * r.iLength, i(a)
										}
										var o, e, l, n, c, d, p = 5,
												r = a.oInstance.fnPagingInfo(),
												u = a.aanFeatures.p,
												m = Math.floor(p / 2);
										for (r.iTotalPages < p ? (c = 1, d = r.iTotalPages) : r.iPage <= m ? (c = 1, d = p) : r.iPage >= r.iTotalPages - m ? (c = r.iTotalPages - p + 1, d = r.iTotalPages) : (c = r.iPage - m + 1, d = c + p - 1), o = 0, e = u.length; e > o; o++) {
												for (s("li:gt(0)", u[o]).filter(":not(:last)").remove(), l = c; d >= l; l++) n = l === r.iPage + 1 ? 'class="active"' : "", s("<li " + n + '><a href="#">' + l + "</a></li>").insertBefore(s("li:last", u[o])[0]).bind("click", t);
												0 === r.iPage ? s("li:first", u[o]).addClass("disabled") : s("li:first", u[o]).removeClass("disabled"), r.iPage === r.iTotalPages - 1 || 0 === r.iTotalPages ? s("li:last", u[o]).addClass("disabled") : s("li:last", u[o]).removeClass("disabled")
										}
								}
						}
				}), a.people = i("./assets/json/people.json").query(), a.dtOptions = t.newOptions().withBootstrap().withOption("sDom", "<'row'<'col-md-6 hidden-xs'l><'col-md-6'f>r>t<'row'<'col-md-6'i><'col-md-6'p>>").withOption("oLanguage", {
						sLengthMenu: "_MENU_",
						...
						s(".dataTables_length select").selectpicker({
								width: "auto"
						})
				})
		}
...
function () {
						...
						link: function (o, e) {
								function l() {
										function e(a) {
												...
												o.app.helpers.isScreen("xs") && t.splice(3, 1);
												var e = new s.Grid({
																columns: t,
																collection: a,
																className: "table table-striped table-editable no-margin mb-sm"
														}),
														l = new s.Extension.Paginator({
																slideScale: .25,
																goBackFirstOnSort: !1,
																collection: a,
																controls: {
												...
												i("#table-dynamic").html("").append(e.render().$el).append(l.render().$el)
										}
										s.InputCellEditor.prototype.attributes["class"] = "form-control input-sm";
										var l = t.Model.extend({}),
												n = t.PageableCollection.extend({
														model: l,
												...
												c = new n,
												d = c;
										i(a).on("sn:resize", function () {
												e(c)
										}), e(c), i("#search-countries").keyup(function () {
												var a = i(this),
														t = d.fullCollection.filter(function (i) {
																return ~i.get("name").toUpperCase().indexOf(a.val().toUpperCase())
														});
												e(new n(t, {
														state: {
																firstPage: 1,
		...
		angular.module("singApp.tables.dynamic").directive("snBackgridDemo", a).factory("Backbone", i).factory("Backgrid", t), a.$inject = ["$window", "jQuery", "Backbone", "Backgrid"], i.$inject = ["$window"], t.$inject = ["$window"]
}(),
function () {
		"use strict";
		...
		var i = angular.module("singApp.tables.basic", ["ui.router"]);
		i.config(a), a.$inject = ["$stateProvider"]
}(),
function () {
		"use strict";
		...
		var i = angular.module("singApp.profile", ["ui.router"]);
		i.config(a), a.$inject = ["$stateProvider"]
}(),
function () {
		"use strict";
		...
		var i = angular.module("singApp.package", ["ui.router"]);
		i.config(a), a.$inject = ["$stateProvider"]
}(),
function () {
		"use strict";
		...
		var i = angular.module("singApp.maps.vector", ["ui.router", "ui.jq"]);
		i.config(a), a.$inject = ["$stateProvider"]
}(),
function () {
		"use strict";
		...
		var i = angular.module("singApp.maps.google", ["ui.router", "singApp.components.gmap"]);
		i.config(a), a.$inject = ["$stateProvider"]
}(),
function () {
		"use strict";
		...
		var i = angular.module("singApp.inbox", ["ui.router", "ui.bootstrap"]);
		i.config(a), a.$inject = ["$stateProvider"]
}(), $(function () {}),
		function () {
				"use strict";
						...
						var a = 33,
								i = Backbone.Model.extend({
										defaults: function () {
												return {
														...
														senderMail: "",
														subject: "",
														body: o[Math.round(3 * Math.random())],
														receiver: "",
								...
								l = Backbone.View.extend({
										...
										selectFolder: function (a) {
												...
												}), f.showEmailsView(), a.preventDefault()
										}
								}),
								n = window.EmailList = Backbone.Collection.extend({
										...
										search: function (a, i) {
												...
												return this.filter(function (a) {
														return a.get("folderId") == i && t.test(a.get("subject")) || t.test(a.get("sender"))
												})
										}
								}),
								c = new n,
								d = Backbone.View.extend({
										...
										formatDate: function (a) {
												...
												return i.getTime() > s ? i.getHours() + ":" + (i.getMinutes() < 10 ? "0" + i.getMinutes() : i.getMinutes()) : ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"][i.getMonth()] + " " + i.getDate()
										},
										toggleSelected: function () {
								...
								p = Backbone.View.extend({
										...
										formatDate: function (a) {
												var i = new Date(a),
														t = new Date,
														s = new Date(t.getFullYear(), t.getMonth(), t.getDate());
												if (i.getTime() > s) return i.getHours() + ":" + (i.getMinutes() < 10 ? "0" + i.getMinutes() : i.getMinutes());
												var o = Math.floor((t.getTime() - i.getTime()) / 864e5);
												return ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"][i.getMonth()] + " " + i.getDate() + " (" + o + " days ago)"
										},
										replyEmail: function () {
								...
								u = Backbone.View.extend({
										...
										initialize: function () {
												this.currentFolderEmails = new n, this.folders = e, this.listenTo(this.currentFolderEmails, "reset", this.renderEmails), this.listenTo(this.currentFolderEmails, "all", this.renderFolderActions), this.listenTo(this.currentFolderEmails, "destroy", this.renderEmails), this.listenTo(this.folders, "change", this.resetEmails)
										},
										render: function () {
										...
										renderFolderActions: function () {
												var a = this.currentFolderEmails.where({
														...
														i = a == this.currentFolderEmails.length;
												this.$toggleAllCheckbox = this.$("#toggle-all"), this.$toggleAllCheckbox.prop("checked", i)
										},
										addOne: function (a) {
												var i = new d({
														model: a
												});
												this.$el.find("tbody").append(i.render().el)
										},
										renderEmails: function () {
												...
												var a = this.folders.where({
														...
														i = (this.currentFolderEmails.where({
																read: !1
														}).length, "Inbox");
												a && (i = a.get("name"))
										},
										...
										resetEmails: function () {
												var i = this.folders.where({
																current: !0
														})[0],
														t = 1;
												i && (t = i.get("id")), t == a ? this.currentFolderEmails.reset(c.where({
														starred: !0
										...
										toggleAll: function () {
												...
												this.currentFolderEmails.each(function (i) {
														i.save({
																selected: a
														})
												})
										...
										search: function () {
												var a = this.folders.where({
														...
														i = 1;
												a && (i = a.get("id")), this.currentFolderEmails.reset(c.search($("#mailbox-search").val(), i))
										},
								...
								v = Backbone.View.extend({
										...
										initialize: function () {
												this.currentView = m, this.folders = e, this.listenTo(this.folders, "reset", this.renderFolders);
												var a = this;
												this.folders.fetch({
														success: function () {
																c.fetch({
										...
										addFolder: function (a) {
												...
												this.$("#folders-list").append(i.render().el)
										},
										search: function () {
		...
		function () {
				...
				var i = angular.module("singApp.grid", ["ui.router"]);
				i.config(a), a.$inject = ["$stateProvider"]
		}(),
		function () {
				"use strict";
								...
								link: function () {
										function i() {
												var i = a(".widget"),
														...
														s = a("#shares-widget"),
														o = a("#autoload-widget");
												i.on("fullscreen.widgster", function () {
														a(".content-wrap").css({
														...
														showLoader: !1,
														closePrompt: function (i) {
																a("#news-close-modal").modal("show"), a("#news-widget-remove").on("click", function () {
																		a("#news-close-modal").on("hidden.bs.modal", i).modal("hide")
																})
														}
												}), s.widgster({
												...
												}), i.widgster(), a(".widget-controls > a").tooltip({
														placement: "bottom"
												})
										}
										i()
		...
		function () {
				...
				var i = angular.module("singApp.form.wizard", ["ui.router", "ui.jq", "singApp.components.wizard"]);
				i.config(a), a.$inject = ["$stateProvider"]
		}(),
		function () {
				"use strict";
				...
				function a(a, i, t, s) {
						function o() {
								s("#fqdn").data("lookup", 1), s("#fqdn").data("is-valid", 1), s("#ip").val("127.0.0.1")
						}
						return a.validateServerLabel = function (a) {
								var i = a.val(),
										t = {};
								return "" === i ? (t.status = !1, t.msg = "Please enter a label") : t.status = !0, t
						}, a.validateFQDN = function (a) {
								var i = s(a),
										t = {};
								return i.is(":disabled") ? t.status = !0 : 0 === i.data("lookup") ? (t.status = !1, t.msg = "Preform lookup first") : 0 === i.data("is-valid") ? (t.status = !1, t.msg = "Lookup Failed") : t.status = !0, t
						}, {
								link: function (e, l, n) {
										function c() {
												var e = l.wizard({
												...
												s("#fqdn").on("input", function () {
														0 !== s(this).val().length ? (s("#ip").val("").attr("disabled", "disabled"), s("#fqdn, #ip").parents(".form-group").removeClass("has-error has-success")) : s("#ip").val("").removeAttr("disabled")
												}), s("#btn-fqdn").find("button").on("click", o);
												var n = /\b(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\b/,
														c = 46;
												s("#ip").on("input", function () {
														0 !== s(this).val().length ? s("#fqdn").val("").attr("disabled", "disabled") : s("#fqdn").val("").removeAttr("disabled")
												}).keypress(function (a) {
														return 8 !== a.which && 0 !== a.which && a.which !== c && (a.which < 48 || a.which > 57) ? (t.log(a.which), !1) : void 0
												}).keyup(function () {
														var a = s(this);
														if (n.test(a.val())) {
																c = 0;
																var i = a.val().substr(a.val().length - 1);
																"." === i && a.val(a.val().slice(0, -1));
																var o = a.val().split(".");
																4 === o.length && (t.log("Valid IP"), a.parents(".form-group").removeClass("has-error").addClass("has-success"))
														} else {
																for (t.log("Not Valid IP"), a.parents(".form-group").removeClass("has-error has-success").addClass("has-error"); - 1 !== a.val().indexOf("..");) a.val(a.val().replace("..", "."));
																c = 46
														}
												}), e.on("closed", function () {
														e.reset()
												}), e.on("reset", function () {
														e.modal.find(":input").val("").removeAttr("disabled"), e.modal.find(".form-group").removeClass("has-error").removeClass("has-succes"), e.modal.find("#fqdn").data("is-valid", 0).data("lookup", 0)
												}), e.on("submit", function (a) {
														({
																hostname: s("#new-server-fqdn").val()
														});
														this.log("seralize()"), this.log(this.serialize()), this.log("serializeArray()"), this.log(this.serializeArray()), i(function () {
														...
														e.reset()
												}), e.el.find(".wizard-progress-container .progress").removeClass("progress-striped").addClass("progress-xs"), s(".wizard-group-list").click(function () {
														a.alert("Disabled for demo.")
												}), s("#open-wizard").click(function (a) {
														a.preventDefault(), e.show()
												})
										}
										c()
								}
		...
		function () {
				...
				var i = angular.module("singApp.form.elements", ["ui.router", "ui.jq", "ui.event", "ngResource", "singApp.components.dropzone", "singApp.components.switchery", "singApp.components.holderjs", "angular-bootstrap-select", "summernote"]);
				i.config(a), a.$inject = ["$stateProvider"]
		}(),
		function () {
				"use strict";
				...
				function a(a, i, t) {
						a.dtChanged = function (a) {
								i.alert("Angular model changed to: " + a)
				...
				function i(a) {
						return {
								link: function (i, t, s) {
										t.on("click", '[data-event="fullscreen"]', function () {
												a(".page-controls").css("z-index", t.find(".note-editor.fullscreen").length ? 0 : "")
										})
								}
						}
				}
				...
				function t(a) {
						a.summernote.renderer.addDialogInfo("link", function (a, t) {
								var s = '<div class="form-group"><label>' + a.link.textToDisplay + '</label><input class="note-link-text form-control" type="text" /></div><div class="form-group"><label>' + a.link.url + '</label><input class="note-link-url form-control" type="text" value="http://" /></div>' + (t.disableLinkTarget ? "" : '<div class="checkbox"><input type="checkbox" checked id="summernoteLinkTargetCheckbox"> <label for="summernoteLinkTargetCheckbox">' + a.link.openInNewWindow + "</label></div>"),
										o = '<button class="btn btn-primary note-link-btn disabled" disabled>' + a.link.insert + "</button>";
								return i("note-link-dialog", a.link.insert, s, o)
						});
						var i = function (a, i, t, s) {
								return '<div class="' + a + ' modal" aria-hidden="false"><div class="modal-dialog"><div class="modal-content">' + (i ? '<div class="modal-header"><button type="button" class="close" aria-hidden="true" tabindex="-1">&times;</button><h4 class="modal-title">' + i + "</h4></div>" : "") + '<div class="modal-body">' + t + "</div>" + (s ? '<div class="modal-footer">' + s + "</div>" : "") + "</div></div></div>"
						}
				}
				angular.module("singApp.form.elements").controller("FormElementsDemoController", a).directive("summernoteFullscreenHelper", i).run(t), a.$inject = ["$scope", "$window", "jQuery"], i.$inject = ["jQuery"], t.$inject = ["jQuery"]
		}(),
		function () {
				"use strict";
				...
				var i = angular.module("singApp.form.validation", ["ui.router"]);
				i.config(a), a.$inject = ["$stateProvider"]
		}(),
		function () {
				"use strict";
				...
				var i = angular.module("singApp.extra.timeline", ["ui.router"]);
				i.config(a), a.$inject = ["$stateProvider"]
		}(),
		function () {
				"use strict";
				...
				var i = angular.module("singApp.extra.search", ["ui.router"]);
				i.config(a), a.$inject = ["$stateProvider"]
		}(),
		function () {
				"use strict";
				...
				var i = angular.module("singApp.login", ["ui.router"]);
				i.config(a), a.$inject = ["$stateProvider"]
		}(),
		function () {
				"use strict";
				...
				var i = angular.module("singApp.extra.invoice", ["ui.router"]);
				i.config(a), a.$inject = ["$stateProvider"]
		}(),
		function () {
				"use strict";
		...
		function () {
				...
				var i = angular.module("singApp.extra.gallery", ["ui.router", "ui.jq", "singApp.components.gallery"]);
				i.config(a), a.$inject = ["$stateProvider"]
		}(),
		function () {
				"use strict";
				...
				function a(a) {
						a.items = [{
								...
								date: "2 mins"
						}], a.activeGroup = "all", a.order = "asc", a.$watch("activeGroup", function (i, t) {
								i !== t && a.$grid.shuffle("shuffle", i)
						}), a.$watch("order", function (i, t) {
								i !== t && a.$grid.shuffle("sort", {
										reverse: "desc" === i,
										by: function (a) {
		...
		function () {
				...
				var i = angular.module("singApp.error", ["ui.router"]);
				i.config(a), a.$inject = ["$stateProvider"]
		}(),
		function () {
				"use strict";
		...
		function () {
				...
				var i = angular.module("singApp.extra.calendar", ["ui.router", "ui.bootstrap", "ui.calendar"]);
				i.config(a), a.$inject = ["$stateProvider"]
		}(),
		function () {
				"use strict";

				function a(a, i, t, s, o) {
						a.uiConfig = {
								calendar: {
										header: {
												left: "",
										...
										select: function (t, s, o) {
												...
												e.result.then(a.addEvent, angular.noop)
										},
										editable: !0,
										droppable: !0,
										drop: function (a, i) {
												var o = {
																title: s.trim(s(i.target).text())
														},
														e = s.extend({}, o);
												e.start = a, e.allDay = !a.hasTime();
												var l = s(i.target).data("event-class");
												l && (e.className = [l]), t.calendars.eventsCalendar.fullCalendar("renderEvent", e, !0), s(i.target).remove()
										},
						...
						}], a.eventSources = [a.events], a.addEvent = function (i) {
								a.events.push(i)
						}, a.changeView = function (a) {
								t.calendars.eventsCalendar.fullCalendar("changeView", a)
						}, a.currentMonth = function () {
								return t.calendars.eventsCalendar ? o(t.calendars.eventsCalendar.fullCalendar("getDate")).format("MMM YYYY") : void 0
						}, a.currentDay = function () {
								return t.calendars.eventsCalendar ? o(t.calendars.eventsCalendar.fullCalendar("getDate")).format("dddd") : void 0
						}, a.prev = function () {
								t.calendars.eventsCalendar.fullCalendar("prev")
						}, a.next = function () {
								t.calendars.eventsCalendar.fullCalendar("next")
						}
				}

				function i(a, i, t) {
						a.event = t, a.ok = function () {
								i.close(a.event)
						}, a.cancel = function () {
								i.dismiss("cancel")
						}
				...
				angular.module("singApp.extra.calendar").controller("CalendarAppController", a).controller("CreateEventModalInstanceCtrl", i).controller("ShowEventModalInstanceCtrl", t).factory("moment", s), a.$inject = ["$scope", "$modal", "uiCalendarConfig", "jQuery", "moment"], i.$inject = ["$scope", "$modalInstance", "event"], t.$inject = ["$scope", "$modalInstance", "event"], s.$inject = ["$window"]
		}(),
		function () {
				"use strict";

				function a(a) {
						a.state("app.ecommerce-product-grid", {
								url: "/ecommerce/products",
								templateUrl: "app/modules/ecommerce-product-grid/ecommerce-product-grid.html"
						})
				}
				var i = angular.module("singApp.ecommerce.grid", ["ui.router"]);
				i.config(a), a.$inject = ["$stateProvider"]
		}(),
		function () {
				"use strict";
				...
				function a(a) {
						a.state("app.ecommerce-product", {
								url: "/ecommerce/product",
								templateUrl: "app/modules/ecommerce-product/ecommerce-product.html"
						})
				}
				var i = angular.module("singApp.ecommerce.product", ["ngSanitize"]);
				i.config(a), a.$inject = ["$stateProvider"]
		}(),
		function () {
				"use strict";
				...
				function a(a) {
						a.isSpecificPageOpened = !1, a.isModalOpened = !1, a.isPageOpened = !1, a.prevTitle = "", a.title = "", a.optionsToDisplay = [], a.activeFilters = {}, a.filters = [{
								id: 0,
								label: "Type",
						...
						}], a.toggleFilter = function (i, t) {
								a.activeFilters[i] === t ? a.activeFilters[i] = null : a.activeFilters[i] = t
						}, a.closeModal = function () {
								a.isModalOpened = !1, a.isPageOpened = !1, a.isSpecificPageOpened = !1, a.optionsToDisplay = []
						}, a.openModal = function (i) {
								a.title = i, a.isModalOpened = !0
						}, a.openPage = function (i) {
								a.isPageOpened = !0, a.titleBuffer = a.title, a.title = i, a.optionsToDisplay = a.filters.find(function (a) {
										return a.label === i
								}).options
						}, a.closePage = function () {
								a.isPageOpened = !1, a.title = a.titleBuffer, a.optionsToDisplay = []
						}, a.openSpecificPage = function (i) {
								a.isSpecificPageOpened = !0, a.isModalOpened = !0, a.isPageOpened = !0, a.title = i, a.optionsToDisplay = a.filters.find(function (a) {
										return a.label === i
								}).options
						}, a.isActive = function (i, t) {
								return a.activeFilters[i] === t
						}
				}
				...
				i.$inject = ["$scope"], a.$inject = ["$scope"], angular.module("singApp.ecommerce.grid").controller("ProductsCtrl", i), angular.module("singApp.ecommerce.grid").controller("PageCtrl", a), angular.module("singApp.ecommerce.product").controller("ProductsCtrl", i)
		}(),
		function () {
				"use strict";

				function a(a) {
						a.size = null, a.quantility = 1, a.changeSize = function (i) {
								a.size = i
						}, a.changeQuantility = function (i) {
								a.quantility = i
						}
				}

				function i(a) {
						a.starred = !1, a.changeStarredBanner = function () {
								a.starred = !a.starred
						}
				}
						...
						return function (a, i, t) {
								function s() {
										var a = window.innerWidth,
												i = 4;
										return 360 > a ? i = 1 : 575 > a ? i = 2 : 992 > a && (i = 3), i
								}
								...
								var e = $(".slick"),
										l = s();
								o(l), $(window).on("resize", function () {
										var a = s();
										a !== l && (l = a, e.slick("slickSetOption", "slidesToShow", l))
								})
						}
				}
				a.$inject = ["$scope"], i.$inject = ["$scope"], t.$inject = ["$scope"], s.$inject = ["jQuery"], angular.module("singApp.ecommerce.product").controller("SelectsController", a).controller("StarController", i).controller("DescriptionController", t).directive("postRepeatDirective", s)
		}(),
		function () {
				"use strict";
				...
				function a(a, i, t, s) {
						var o = this;
						o.title = a.appTitle, i.app = a, i.$state = s, angular.isDefined(t.state) ? i.app.state = t.state : t.state = i.app.state
				}
				...
				function t(a, i, t) {
						return function (s, o) {
								var e = i.JSON.parse(i.localStorage.getItem("sing-2-angular-errors")) || {};
								e[(new Date).getTime()] = arguments, i.localStorage.setItem("sing-2-angular-errors", i.JSON.stringify(e)), t.get("config").debug && (a.error.apply(a, arguments), i.alert("check errors"))
						}
				}
				angular.module("singApp.core").controller("App", a).factory("jQuery", i).factory("$exceptionHandler", t), a.$inject = ["config", "$scope", "$localStorage", "$state"], i.$inject = ["$window"], t.$inject = ["$log", "$window", "$injector"]
		}(),
		function () {
				"use strict";
				...
				function a(a, t, s, o) {
						...
						return e.prototype = {
								...
								isScreen: function (a) {
										var s = t.innerWidth;
										return (s >= i.settings.screens[a + "-min"] || "xs" === a) && (s <= i.settings.screens[a + "-max"] || "lg" === a)
								},
								getScreenSize: function () {
										var a = t.innerWidth;
										return a <= i.settings.screens["xs-max"] ? "xs" : a >= i.settings.screens["sm-min"] && a <= i.settings.screens["sm-max"] ? "sm" : a >= i.settings.screens["md-min"] && a <= i.settings.screens["md-max"] ? "md" : a >= i.settings.screens["lg-min"] ? "lg" : void 0
								},
								onScreenSize: function (a, i, t) {
										t = "undefined" != typeof t ? t : !0, this._screenSizeCallbacks[a][t ? "enter" : "exit"].push(i)
								},
								changeColor: function (a, i, t) {
										var s = function (a, i) {
												var t = "0";
												for (a += ""; a.length < i;) a = t + a;
												return a
										};
										a = a.replace(/^\s*|\s*$/, ""), a = a.replace(/^#?([a-f0-9])([a-f0-9])([a-f0-9])$/i, "#$1$1$2$2$3$3");
										var o = Math.round(256 * i) * (t ? -1 : 1),
												...
												l = e && null !== e[4] ? e[4] : null,
												n = e ? [e[1], e[2], e[3]] : a.replace(/^#?([a-f0-9][a-f0-9])([a-f0-9][a-f0-9])([a-f0-9][a-f0-9])/i, function () {
														return parseInt(arguments[1], 16) + "," + parseInt(arguments[2], 16) + "," + parseInt(arguments[3], 16)
												}).split(/,/);
										return e ? "rgb" + (null !== l ? "a" : "") + "(" + Math[t ? "max" : "min"](parseInt(n[0], 10) + o, t ? 0 : 255) + ", " + Math[t ? "max" : "min"](parseInt(n[1], 10) + o, t ? 0 : 255) + ", " + Math[t ? "max" : "min"](parseInt(n[2], 10) + o, t ? 0 : 255) + (null !== l ? ", " + l : "") + ")" : ["#", s(Math[t ? "max" : "min"](parseInt(n[0], 10) + o, t ? 0 : 255).toString(16), 2), s(Math[t ? "max" : "min"](parseInt(n[1], 10) + o, t ? 0 : 255).toString(16), 2), s(Math[t ? "max" : "min"](parseInt(n[2], 10) + o, t ? 0 : 255).toString(16), 2)].join("")
								},
								lightenColor: function (a, i) {
										return this.changeColor(a, i, !1)
								},
								darkenColor: function (a, i) {
										return this.changeColor(a, i, !0)
								},
								max: function (a) {
								...
								_initResizeEvent: function () {
										...
										a(t).on("resize", function () {
												s.cancel(i), i = s(function () {
														a(t).trigger("sn:resize")
												}, 100)
										})
								},
								_initOnScreenSizeCallbacks: function () {
										...
										a(t).resize(function () {
												s.cancel(i), i = s(function () {
														var a = e.getScreenSize();
														a !== l && (e._screenSizeCallbacks[l].exit.forEach(function (i) {
																i(a, l)
														}), e._screenSizeCallbacks[a].enter.forEach(function (i) {
																i(a, l)
														}), o.log("screen changed. new: " + a + ", old: " + l)), l = a
												}, 100)
										})
								}
						}, i.helpers = new e, i
				}
				var i = (angular.module("singApp.core").factory("config", a), {
						name: "sing",
						title: "Sing App - AngularJS Dashboard",
						version: "4.0.2",
						debug: !0,
						settings: {
								colors: {
		...
		function () {
				...
				var i = angular.module("singApp.dashboard", ["ui.router", "ui.jq", "singApp.components.rickshaw"]);
				i.config(a), a.$inject = ["$stateProvider"]
		}(),
		function () {
				"use strict";
						...
						a.mapData = {
								map: {
										...
										defaultPlot: {
												size: 17,
												attrs: {
														fill: i.settings.colors["brand-warning"],
														stroke: "#fff",
														"stroke-width": 0,
														"stroke-linejoin": "round"
												},
				...
				function s(a) {
						var i = new Date;
						a.month = i.getMonth() + 1, a.year = i.getFullYear()
				}
										...
										function o() {
												function o() {
														c.find(".event").each(function () {
																var i = a(this),
																		t = a("<span></span>");
																t.css("background-color", i.css("background-color")).appendTo(i.find("a")), i.css("background-color", "")
														})
												}
												...
												}), c.find(".icon-arrow-left").addClass("fa fa-arrow-left"), c.find(".icon-arrow-right").addClass("fa fa-arrow-right"), c.find(".icon-arrow-left, .icon-arrow-right").parent().on("click", o), o()
										}
										s.$observe("events", function () {
												o()
										})
								}
						}
				}
				angular.module("singApp.dashboard").controller("DashboardController", a).controller("GeoLocationsWidgetDemoController", i).controller("MarketStatsWidgetDemoController", t).controller("BootstrapCalendarDemoController", s).directive("bootstrapCalendar", o), a.$inject = ["$scope"], i.$inject = ["$scope", "config"], t.$inject = ["$scope", "Rickshaw"], s.$inject = ["$scope"], o.$inject = ["jQuery"]
		}(),
		function () {
				"use strict";
				...
				var i = angular.module("singApp.charts", ["ui.router", "ui.jq", "singApp.components.sparkline", "singApp.components.nvd3", "singApp.components.morris"]);
				i.config(a), a.$inject = ["$stateProvider"]
		}(),
		function () {
				"use strict";
				...
				function a(a, i, t, s) {
						a.data1 = [
								...
								function i(a, i, s) {
										function o(a) {
												for (var t = 1 / (.1 + Math.random()), s = 2 * Math.random() - .5, o = 10 / (.1 + Math.random()), e = 0; i > e; e++) {
														var l = (e / i - s) * o;
														a[e] += t * Math.exp(-l * l)
												}
										}
										return arguments.length < 3 && (s = 0), t.range(a).map(function () {
												var a, t = [];
												for (a = 0; i > a; a++) t[a] = s + s * Math.random();
												for (a = 0; 5 > a; a++) o(t);
								...
								function o(a, t) {
										var s = (new Date).getTime(),
												...
												t = t || 45,
												c = e / t;
										return i(a.length, t, .1).map(function (i, t) {
												return {
														key: a[t],
														values: i.map(function (a, i) {
																return {
																		x: n + a.x * o * c,
								...
								a.nvd31Chart = s.models.lineChart().useInteractiveGuideline(!0).margin({
										left: 28,
										bottom: 30,
										right: 0
								}).color(["#82DFD6", "#ddd"]), a.nvd31Chart.xAxis.showMaxMin(!1).tickFormat(function (a) {
										return t.time.format("%b %d")(new Date(a))
								}), a.nvd31Chart.yAxis.showMaxMin(!1).tickFormat(t.format(",f")), a.nvd31Data = o(["Search", "Referral"], 50).map(function (a, i) {
										return a.area = !0, a
								}), a.nvd32Chart = s.models.multiBarChart().margin({
										left: 28,
										bottom: 30,
										right: 0
								}).color(["#F7653F", "#ddd"]), a.nvd32Chart.xAxis.showMaxMin(!1).tickFormat(function (a) {
										return t.time.format("%b %d")(new Date(a))
								}), a.nvd32Chart.yAxis.showMaxMin(!1).tickFormat(t.format(",f")), a.nvd32Data = o(["Uploads", "Downloads"], 10).map(function (a, i) {
										return a.area = !0, a
								})
												...
												a.plotAnimator(t, i[s.ngModel], {
														xaxis: {
																...
																font: {
																		lineHeight: 13,
																		weight: "bold",
																		color: i.app.settings.colors["gray-semi-light"]
																}
														},
														yaxis: {
																tickDecimals: 0,
